-- currently using dracula.nvim - check groups of other themes
-- replace temporary color names and improve bad usage
...
-- TODO: search highlights are buggy, play with colors
...
local groups = {
	...
	htmlH1 = { fg = colors.colors[2] },
	htmlH2 = { fg = colors.colors[4] },
	htmlH3 = { fg = colors.colors[6] },
	htmlH4 = { fg = colors.colors[8] },
	htmlH5 = { fg = colors.colors[10] },
	htmlH6 = { fg = colors.colors[12] },
	...
	markdownItalic = { fg = colors.chartreuse, italic = true },
	...
	TelescopeNormal = { fg = colors.fg, bg = nil },
	...
	-- TS rainbow colors
	rainbowcol1 = { fg = colors.colors[2] },
	rainbowcol2 = { fg = colors.colors[4] },
	rainbowcol3 = { fg = colors.colors[6] },
	rainbowcol4 = { fg = colors.colors[8] },
	rainbowcol5 = { fg = colors.colors[10] },
	rainbowcol6 = { fg = colors.colors[12] },
	rainbowcol7 = { fg = colors.colors[2] },

	-- Rainbow delimiter
	RainbowDelimiterRed = { fg = colors.colors[2] },
	RainbowDelimiterYellow = { fg = colors.colors[4] },
	RainbowDelimiterBlue = { fg = colors.colors[6] },
	RainbowDelimiterOrange = { fg = colors.colors[8] },
	RainbowDelimiterGreen = { fg = colors.colors[10] },
	RainbowDelimiterViolet = { fg = colors.colors[12] },
	RainbowDelimiterCyan = { fg = colors.colors[2] },
...
-- TODO: why is any of this important?
return {
